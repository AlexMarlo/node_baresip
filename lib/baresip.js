...
function Baresip() {
    ...
    self.muteUnmute = function ( callback) {
        baresipWrapper.muteUnmute( function( err, res){
            if( err)
                callback( err);
            callback( null, true);
        });
    ...
    self.holdPreviousCall = function ( callback) {
        baresipWrapper.holdPreviousCall( function( err, res){
            if( err)
                callback( err);
            callback( null, true);
        });
    ...
    self.hold = function ( callback) {
        baresipWrapper.hold( function( err, res){
            if( err)
                callback( err);
            callback( null, true);
        });
    ...
    self.resume = function ( callback) {
        baresipWrapper.resume( function( err, res){
            if( err)
                callback( err);
            callback( null, true);
        });
